...
import { CLIENT_CANCELLATION_LOCK_HOURS, CLIENT_CANCELLATION_PRELOCK_REMINDER_MINUTES } from '../appointment/appointment.constants.js';
...
const EVENT_TEMPLATES = {
    ...
    APPT_REMINDER_1H10_CLIENT: {
        ...
        body: () => `Votre rendez-vous est dans ${cancellationLockReminderLabel}. L'annulation sera impossible si le temps restant est inferieur a ${CLIENT_CANCELLATION_LOCK_HOURS} heures.`,
        priority: 'HIGH'
    },
